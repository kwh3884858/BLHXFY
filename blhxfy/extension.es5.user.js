...
(function () {
  ...
  var getLocalConfig = function getLocalConfig() {
    ...
    var keys = ['autoDownload', 'bottomToolbar', 'displayName', 'removeScroller', 'hideSidebar', 'originText', 'storyOnly', 'showTranslator', 'transJa', 'transEn', 'font', 'transApi', 'fontBold', 'plainText', 'battleTrans', 'log', 'defaultFont'];
